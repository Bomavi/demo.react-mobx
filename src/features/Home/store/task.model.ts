...
export interface TaskModel {
	...
	setActionInProgress(action: TaskActionInProgress, state: boolean): void;
}

export const createTaskModel = (props: Partial<TaskType>): TaskModel => {
	return makeAutoObservable<TaskModel>(
		{
			id: props._id || '',
			...
			setActionInProgress(action, state) {
				try {
